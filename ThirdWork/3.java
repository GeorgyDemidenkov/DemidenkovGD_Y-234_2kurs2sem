...
class VotingSystem {
    ...
    public VotingSystem() {
        ...
        users.add(new User("admin", "Admin@1234", "admin", "Иванов Иван Иванович", "01.01.1980", "123-456-789 00"));
        // Добавляем тестового пользователя
        users.add(new User("user1", "User@1111", "user", "Петрова Анна Сергеевна", "15.05.1990", "111-222-333 11"));
        // Добавляем тестового ЦИК
        users.add(new User("cec", "Cec@2024", "cec", "Сидоров Алексей Владимирович", "10.10.1975", ""));
        // Добавляем еще одного пользователя
        users.add(new User("user2", "User@2222", "user", "Кузнецова Елена Дмитриевна", "20.07.1985", "222-333-444 22"));
    }
